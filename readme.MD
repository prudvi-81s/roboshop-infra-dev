...
```
 mysql -h roboshop-dev.cpscq6wqsy09.us-east-1.rds.amazonaws.com -u root -pRoboShop1
```
...
```
mysql -h roboshop-dev.cpscq6wqsy09.us-east-1.rds.amazonaws.com -u root -pRoboShop1 < shipping/db/schema.sql
```
```
mysql -h roboshop-dev.cpscq6wqsy09.us-east-1.rds.amazonaws.com -u root -pRoboShop1 < shipping/db/app-user.sql
```
```
mysql -h roboshop-dev.cpscq6wqsy09.us-east-1.rds.amazonaws.com -u root -pRoboShop1 < shipping/db/master-data.sql
```
